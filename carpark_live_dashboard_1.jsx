...
// ━━━ Theme ━━━
const C = {
  bg: "#080b16", bg2: "#0d1121",
  card: "#131828", cardHi: "#1a2038",
  border: "#1f2744", borderHi: "#2d3a5c",
  tx: "#e8ecf4", txm: "#6b7a9e", txd: "#3e4d70",
...
export default function Dashboard() {
  ...
  return (
    <div style={{
      ...
      background: `radial-gradient(ellipse at 30% -10%, #1a1040 0%, ${C.bg} 60%), ${C.bg}`,
      paddingBottom: 60,
    }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 20px" }}>
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 20, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <button onClick={fetchData} disabled={loading} style={{
            ...sel, background: loading ? C.border : "linear-gradient(135deg, #f97316, #ea580c)",
